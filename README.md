...
The v0.68 sanitized tests cover missing/stale Greenhouse form review, already-satisfied or foreign controls, cross-portal review injection, unrecognized request authority, sensitive-value handling, renderer composition and explicit manual handoff. The complete exact-commit source gate will be recorded in the readiness audit before publication. This source slice does not establish live compatibility. Package, protected CI/security, signing, authorized live-provider/portal use, and physical installed-app acceptance remain separate; no older package or protected result transfers.
