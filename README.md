...
The v0.67 sanitized tests cover upload and navigation approval/cancellation, stale previews, exact document-byte binding, changed controls/pages/origins, postcondition failure, user takeover, no automatic retry, and final-confirmation separation. This source slice does not establish live compatibility. Package, protected CI/security, signing, authorized live-provider/portal use, and physical installed-app acceptance remain separate; no older package or protected result transfers.
