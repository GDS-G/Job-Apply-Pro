...
## Greenhouse Form Execution Contracts build

The active source milestone is **Greenhouse Form Execution Contracts `v0.66.0-alpha.1`**. The v0.65 reviewed launch now feeds a Greenhouse-only current-page assessment for application, document, questionnaire, review, and confirmation stages. It classifies required native fields, exact document-upload review, custom/manual controls, unique navigation, final-submit separation, and explicit postconditions under a fingerprinted contract. The desktop explains each blocking control without exposing answer values. See [ADR-0076](docs/adr/0076-greenhouse-form-execution-contracts.md) and [ADR-0075](docs/adr/0075-reviewed-greenhouse-application-launch.md).
...
The v0.66 sanitized corpus exercises every recognized Greenhouse form stage plus success and refusal cases for required fields, upload filenames, custom widgets, navigation, origin escape, stale review, and same-page transitions. It does not dispatch upload or navigation actions and does not establish live compatibility. Exact source checkpoint `09b3bf73be7196fdffa34068c9963e3bb2910072` passes 1,825 backend tests at 86.86% coverage and 486 desktop tests with two packaged-runtime opt-ins skipped; full static analysis and production builds pass. Package, protected CI/security, signing, authorized live-provider/portal use, and physical installed-app acceptance remain separate; no older package or protected result transfers.
