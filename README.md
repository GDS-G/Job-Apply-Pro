...
The v0.66 sanitized corpus exercises every recognized Greenhouse form stage plus success and refusal cases for required fields, upload filenames, custom widgets, navigation, origin escape, stale review, and same-page transitions. It does not dispatch upload or navigation actions and does not establish live compatibility. Exact full-source validation is recorded in the production-readiness audit for the committed candidate. Package, protected CI/security, signing, authorized live-provider/portal use, and physical installed-app acceptance remain separate; no older package or protected result transfers.
