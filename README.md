...
The v0.69 sanitized tests cover missing/stale Greenhouse form review, multiple submit controls, cross-portal review injection, unrecognized request authority, exact-locator dispatch, renderer composition, and identifier-backed confirmation. The complete exact-commit source gate will be recorded in the readiness audit before publication. This source slice does not establish live compatibility. Package, protected CI/security, signing, authorized live-provider/portal use, and physical installed-app acceptance remain separate; no older package or protected result transfers.
