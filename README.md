...
Focused v0.63 source checks pass across the AI/provider/media/knowledge, external-effect/browser/portal/challenge and complete restore/rollback compatibility groups, plus Ruff and strict mypy. Full repository gates, the v0.63 unsigned package candidate, protected CI/security, authorized live-provider use and physical installed-app acceptance remain separate. The exact v0.62 package evidence remains recorded historically in the production-readiness audit and does not transfer to v0.63.
