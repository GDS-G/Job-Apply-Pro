...
3. Execute only current approved portal-field bindings after a fresh observation verifies page fingerprint, control identity, constraints, answer revision, and permission; add portal-specific mappings only from authorized supervised evidence with terms, limits, ownership, and stop conditions.
