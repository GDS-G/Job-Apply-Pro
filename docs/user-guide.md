...
This guide applies to Portal Readiness `v0.12.2-alpha.1`. This is an alpha build: real portal submission and live mail/calendar writes remain disabled by default.

## Install and start

1. Download the signed `Job-Apply-Pro-0.12.2-alpha.1-x64.exe` installer from the repository release.
