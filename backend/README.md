...
The AI Gateway build exposes health, runtime status, workflow controls, event history, candidate, job, application, encrypted-backup, resumable-checkpoint, browser-session, candidate-knowledge, and governed AI endpoints under `/api/v1`.
