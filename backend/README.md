...
The Portal Vertical Slice build exposes health, runtime status, workflow controls, event history, candidate, job, application, encrypted-backup, resumable-checkpoint, browser-session, candidate-knowledge, governed AI, and reference-portal endpoints under `/api/v1`.
